        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Accounts_SeededAccountStaysActive", "[IsSeeded] = 0 OR [IsActive] = 1");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ClassTeachers_EndsAfterStart", "[EndedAtUtc] IS NULL OR [EndedAtUtc] > [StartedAtUtc]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_OnlyOneSeededAdmin",
                table: "Accounts",
                column: "IsSeeded",
                unique: true,
                filter: "[IsSeeded] = 1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_ClassId_LocalDate",
                table: "ActivityLogs",
                columns: new[] { "ClassId", "LocalDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_StudentId_LocalDate_LogType",
                table: "ActivityLogs",
                columns: new[] { "StudentId", "LocalDate", "LogType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassTeachers_ClassId_EndedAtUtc",
                table: "ClassTeachers",
                columns: new[] { "ClassId", "EndedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_ClassTeachers_OneCurrentPermanentTeacherPerClass",
                table: "ClassTeachers",
                column: "ClassId",
                unique: true,
                filter: "[EndedAtUtc] IS NULL AND [AssignmentType] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_ClassTeachers_TeacherAccountId_EndedAtUtc",
                table: "ClassTeachers",
                columns: new[] { "TeacherAccountId", "EndedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_AccountId_RevokedAtUtc",
                table: "RefreshTokens",
